          ...
          <div id="select-butn-fileter-container-indiv">
            <div>
              <button
                ...
                onDoubleClick={() => setSelectBtn(true)}
                id="button-of-the-filete-the-data-in-bookin-page"
              >
                CarType
              </button>
              {selectBtn ? (
                <div id="car-type-filter-in-booking-page">
                  <input
                    type="checkbox"
                    className="checkbox-in-filter-in-cartype"
                    onClick={filterFunc}
                    id="UV"
                  />
                  <label>UV</label>
            ...
            <div>
              <button
                onClick={() => setSelectSeating(false)}
                onDoubleClick={() => setSelectSeating(true)}
                id="button-of-the-filete-the-data-in-bookin-page"
              >
                Seating
              </button>
            ...
            <div>
              <button
                onClick={() => setMilageSelect(false)}
                onDoubleClick={() => setMilageSelect(true)}
                id="button-of-the-filete-the-data-in-bookin-page"
              >
                Milage
              </button>
                ...
                return (
                  <div key={i} id="card-of-the-order-page-i-make-this">
                    <div className="img-of-te-car-details-order">
                      <img
                        src={`https://car-rental-app-server.onrender.com/cars/${d.image}`}
                        id="img-of-the-car-order"
                      />
                    </div>
                    <div id="seater">
                    ...
                    <div id="booking">
                      ...
                      <Link to="/payment">
                        {" "}
                        <span
                          onClick={() => setCarData(d)}
                          id="book-now-of-the-car"
                        >
                          Book Now
                        </span>
                      </Link>
