          ...
          <div className="contanermaginc-lum">
            <div className="cardetail-app">
              <div className="upper">
                ...
                <div className="comp">
                  <div className="bobob">
                    <li className="name-of-the-page-payment-of-the-car">
                      Car Name :{" "}
                    </li>
                    <li className="name-of-the-page-payment-of-the-car">
                      Car Model:
                  ...
                  <div className="bobob">
                    <li className="ans-of-the-file-payment-in-data-of-file">
                      {CarData.name}
                    </li>
                    <li className="ans-of-the-file-payment-in-data-of-file">
                      {CarData.model}
                  ...
                  <div className="image-of-car-in-rental-payment">
                    <img
                      src={`https://car-rental-app-server.onrender.com/cars/${CarData.image}`}
                      alt="not availble"
                      className="img"
                    />
                  </div>
            ...
            <div className="payment">
              ...
              <div className="paylower">
                <li className="indiv-sub-class name-of-the-page-payment-of-the-car">
                  Grand TOTAL
                </li>
                <li className="ans-of-the-file-payment-in-data-of-file-total">
                  {total} RS
                </li>
              </div>

              <button className="payment-button" onClick={Proceed}>
                proceed
              </button>
            </div>
          </div>
